...
I started in basic html css and js (huge mistake).

Then I tried going local with python qt.

That was horrible, so I tried cpp qt.

That was even worse, so I restarted with next.js.

At first, I used github api only and tried making a wrapper on codespaces.
